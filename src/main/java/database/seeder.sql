...
INSERT INTO `ads` (`id`, `user_id`, `title`, `description`) VALUES (6, 6, 'Eligendi molestias et sunt exercitationem quia sint temporibus.', 'Est nihil et facilis omnis. Est nemo debitis et rerum et impedit tempore. Iusto mollitia voluptate excepturi iure ipsum cupiditate saepe.');
INSERT INTO `ads` (`id`, `user_id`, `title`, `description`) VALUES (7, 7, 'Voluptatem quia sint assumenda assumenda sint rerum officia ut.', 'Eos quo nisi quam necessitatibus. Et aut nihil ut accusantium quasi ipsa quisquam omnis. Cum unde in quia saepe explicabo ea expedita.');
INSERT INTO `ads` (`id`, `user_id`, `title`, `description`) VALUES (8, 8, 'Repudiandae qui non dicta fuga et quae.', 'Illum sed alias repudiandae sequi aut. Dicta ex quo error qui tempore nihil est. Mollitia sit tempore necessitatibus natus sunt officiis facere. Maxime quas aliquam provident quis iure.');
INSERT INTO `ads` (`id`, `user_id`, `title`, `description`) VALUES (9, 9, 'Assumenda consectetur et amet sed mollitia consequuntur qui.', 'Assumenda fugit est tempore eum ut quibusdam aut. Ut rerum voluptates optio sed sed. Et sed a exercitationem molestias sit autem.');
INSERT INTO `ads` (`id`, `user_id`, `title`, `description`) VALUES (10, 10, 'Vitae cupiditate et nam quod deserunt.', 'Iure quos asperiores quis sequi quia id facere deserunt. Dignissimos quasi voluptatibus quia ex enim. Sint sit qui in et et nam aspernatur.');
